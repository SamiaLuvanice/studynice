  ...
  return (
    <div
      className={cn(
        ...
        variant === 'streak' && "border-streak/20 bg-gradient-to-br from-streak/5 to-accent/10",
        className
      )}
    >
        ...
        <div className="space-y-1">
          ...
          <p
            className={cn(
              ...
              variant === 'streak' && "text-gradient-streak",
        ...
        {icon && (
          <div
            className={cn(
              ...
              variant === 'streak' && "bg-streak/10 text-streak",
